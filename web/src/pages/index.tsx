...
import logoImd from '../assets/logo.svg';
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        <Image src={logoImd} alt="Nlw copa" />
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            className="flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm text-gray-400" 
            type="text" 
            required 
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo uma previa de aplicação móvel" quality={100}/>
    </div>
  )
}
